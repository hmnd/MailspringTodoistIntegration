(function(){
  ...
  createClass = require('nylas-exports').React.createClass;
  ref$ = require('nylas-exports').ReactDOM, render = ref$.render, unmountComponentAtNode = ref$.unmountComponentAtNode;
